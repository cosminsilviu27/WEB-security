...
?>
					...
					<form class="register-form" role="form" method="post" action="http://localhost/dashboard/protectedshop/change.php">
...
<form class="register-form" role="form" action="http://localhost/dashboard/protectedshop/change-password.php" 
	method="post" name="chngpwd" onSubmit="return valid();">
	<div class="form-group">
		<input type="hidden" name="token" value="<?php echo $token; ?>" /> <!-- send user token  -->
