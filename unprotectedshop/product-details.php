...
{
	mysqli_query($con,"insert into productreviews(productId,quality,price,value,name,summary,review) values('$pid','$quality','$price','$value','$name','$summary','$review'");
}
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									Price. <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
...
<?php 
$review = $_POST['review'];
$rt=mysqli_query($con,"select * from productreviews where review = $review");
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">Price. <?php echo htmlentities($row['productPrice']);?></span>
										</div>
									</div>
...
<?php 
$review = $_POST['review'];
$qry=mysqli_query($con,"select * from productreviews where review = $review");
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					Price.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">Price.
